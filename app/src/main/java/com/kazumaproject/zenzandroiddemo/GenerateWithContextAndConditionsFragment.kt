...
class GenerateWithContextAndConditionsFragment : Fragment() {
    ...
    private lateinit var preferenceEditText: EditText
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_generate_with_conditions, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        styleEditText = view.findViewById(R.id.styleEditText)
        preferenceEditText = view.findViewById(R.id.preferenceEditText)
        ...
        convertButton.setOnClickListener {
            ...
            val profile = profileEditText.text.toString().trim()
            val topic = topicEditText.text.toString().trim()
            val style = styleEditText.text.toString().trim()
            val preference = preferenceEditText.text.toString().trim()
